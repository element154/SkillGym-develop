## Source: https://docs.sympy.org/latest/install.html
...
Many Linux distributions package SymPy, for example on Debian based systems SymPy can be installed with apt:
