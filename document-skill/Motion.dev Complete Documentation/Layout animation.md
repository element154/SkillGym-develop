# Layout Animation â React FLIP & Shared Element | Motion
...
```
< motion . div layout animate = { { opacity : 0.5 } } transition = { { ease : "linear" , layout : { duration : 0.3 } } } />
```
...
```
// Pin element to center < motion . ul layout > < motion . li layout layoutAnchor = { { x : 0.5 , y : 0.5 } } transition = { { delay : 1 } } /> </ motion . ul >
```
...
- Install Motion Studio Enhance Copilot with Motion docs, and add visual animation editing tools for CSS and Motion. Install Motion Studio Enhance Copilot with Motion docs, and add visual animation editing tools for CSS and Motion.
...
- Motion+ AnimateNumber Create beautiful number ticker and countdown animations in React. Motion+ AnimateNumber Create beautiful number ticker and countdown animations in React.
...
- Layout animation examples See all examples & tutorials, with full copy & paste source code.
...
- Tutorial iOS App Store An example of animating cards inspired by the iOS App Store using Motion for React's layout animations.
...
## Go further with Motion+

Unlock premium layout animation examples, advanced shared-element patterns, and production-ready code.
