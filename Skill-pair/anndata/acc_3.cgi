...
<meta name="ncbi_phid" content="0751CB139D0DB9610000000000000001">
<meta name="ncbi_sessionid" content="0751CB139D0DB961_0000SID">
...
<td align="right">Not logged in | <a href="/geo/submitter?ix=1f5rqQe8TKQIgnSCoNNuYbK359YuNFAeJ-rbhl4ryMD4pyAWAtDa9mX3bHZO_ubw1-FEEWoKPJnSOCZsOXe5qM">Login</a><a href="javascript:RPopUpWindow_Set(geologinbar_login,260,200,'','','#E1EAE6','','#538AA9','MessageBox2');" onmouseout="RPopUpWindow_Stop()"><img alt="Help" height="11" src="/coreweb/images/long_help4.gif" style="border: none" width="19"></a></td>
</tr></table>
                    </td>
...
&nbsp;<label for="geo_acc">GEO accession: </label><input id="geo_acc" name="acc" onkeydown="ViewOptionsFormKeyDown(event)" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_acc)" style="font-size: 10px" type="text" value="GSM6278577">&nbsp;&nbsp;</td>
<td valign="middle"><img alt="Go" border="0" onclick="SubmitViewOptionsForm()" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_go)" src="/geo/img/buttons/go_button.gif"></td>
    ...
    <table><tr><td><table cellpadding="2" cellspacing="0" width="600"><tr bgcolor="#cccccc" valign="top"><td colspan="2"><table width="600"><tr><td><strong class="acc" id="GSM6278577"><a href="/geo/query/acc.cgi?acc=GSM6278577" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">Sample GSM6278577</a></strong></td>
<td></td>
<td align="right" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_gds)"><a href="/gds/?term=GSM6278577[Accession]">Query DataSets for GSM6278577</a></td>
</tr></table></td></tr>
<tr valign="top"><td>Status</td>
<td>Public on Jun 26, 2023</td>
</tr>
<tr valign="top"><td nowrap>Title</td>
<td style="text-align: justify">UPN4 PrePost T Enriched</td>
</tr>
...
<td style="text-align: justify">Bone Marrow Aspirate<br></td>
</tr>
...
<td style="text-align: justify">tissue: Bone Marrow Aspirate<br>disease state: AML<br></td>
</tr>
<tr valign="top"><td nowrap>Extracted molecule</td>
<td>total RNA</td>
</tr>
<tr valign="top"><td nowrap>Extraction protocol</td>
<td style="text-align: justify">Frozen human bone marrow specimens were thawed and transferred into 5mL polypropylene FACS tubes and resuspended in 4mL PBS + 2mM EDTA + 2% FBS (staining buffer). Cell suspensions were centrifuged at 500g for 5 minutes at 4°C and supernatant was discarded (all subsequent wash steps performed the same way). Cell pellets were re-suspended in staining buffer and counted. For each sample with &gt; 106 live cells, 70% was used for T cell sorting (described below). The remaining 30% of the sample, or the entire sample for those with &lt; 106 live cells, were washed and proceeded to dead cell removal (Miltenyi Biotec). Dead cells were depleted according to manufacturer’s instructions, with the exception of the incubation period shortened to 5 minutes and column washes reduced to 3 times. The live cell fraction was washed, resuspended in staining buffer, and counted. Samples were re-suspended in PBS + 2% FBS (labeling buffer) and Human FcR Blocking Reagent (1:50, Miltenyi Biotec) and incubated on ice for 5 minutes. Samples were tagged with cell hashing (Stoeckius et al., 2018) oligo-tagged antibodies (TotalSeq-C0251 anti-human hashtag 1 antibody and TotalSeq-C0252 anti-human hashtag 2 antibody, BioLegend) according to manufacturer’s instructions. After tagging, samples were washed 3 times in labeling buffer, and then each patient’s samples were pooled together and washed. Samples were re-suspended in labeling buffer and Human FcR Blocking Reagent (1:50, Miltenyi Biotec) and incubated on ice for 5 minutes. CITE-Seq antibodies (TotalSeq-C Human Universal Cocktail, BioLegend) were stained according to manufacturer’s instructions (<a href="https://cite-seq.com/protocol/">https://cite-seq.com/protocol/</a>) using the above described labeling buffer for all steps. After staining, samples were washed 3 times in labeling buffer and resuspended at a concentration of 103 cells per μL in cold PBS + 0.04% BSA (sequencing buffer).<br>Fresh cells were stained with Trypan blue and Countess II Automated Cell Counter (ThermoFisher) was used to assess both cell number and viability. Following quality control (QC), the single cell suspension was loaded onto a Chromium Next GEM Chip K (10X Genomics PN 1000286). GEM generation, cDNA synthesis, cDNA amplification, and library preparation of 2,000-14,000 cells proceeded using the Chromium Next GEM Single Cell 5’ Kit v2 (10X Genomics PN 1000263) according to the manufacturer’s protocol. cDNA amplification included 13-14 cycles, and 38-50ng of the material was used to prepare sequencing libraries with 14 cycles of PCR. Indexed libraries were pooled equimolar and sequenced on a NovaSeq 6000 in a PE28/91 run using the NovaSeq 6000 S1 or S2 Reagent Kit (100 or 200 cycles) (Illumina). An average of 263 million paired reads were generated per sample.<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td style="text-align: justify">Filtered gene expression matrices were generated using 10X CellRanger (version 6.0.1).<br>Paired single-cell VDJ sequences and annotations were generated using 10X Cellranger VDJ (version 6.0.1) and high confidence sequences were mapped to gene expression barcodes.<br>Feature barcode matrices were generated for each CITE-seq sample using antibody barcode patterns from TotalSeq.<br>Assembly: GRCh38<br>Supplementary files format and content: *_GEX.h5 CellRanger h5 Gene by Cell Matrix<br>Supplementary files format and content: *_FB.h5 CellRanger h5 Gene by Cell Matrix<br>Supplementary files format and content: *_VDJ.csv CellRanger h5 Gene by Cell Matrix<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td><a href="mailto:shahids@mskcc.org">shahids@mskcc.org</a><br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Organization name</td>
<td style="text-align: justify">Memorial Sloan Kettering Cancer Center<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Department</td>
<td style="text-align: justify">Department of Pediatrics<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Lab</td>
<td style="text-align: justify">The Katharine Hsu lab<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Street address</td>
<td style="text-align: justify">1275 York Avenue<br></td>
</tr>
...
<td style="text-align: justify">10065</td>
</tr>
...
<td onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)"><table cellpadding="3" style="position:relative;top:-5px;left:-5px"><tr><td valign="top"><a href="/geo/query/acc.cgi?acc=GSE207104" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">GSE207104</a></td>
<td valign="top">​​Immune Escape after Allogeneic Hematopoietic Cell Transplantation in Pediatric Patients with Acute Myeloid Leukemia</td>
</tr></table></td>
</tr>
<tr valign="top"><td colspan="2"><strong>Relations</strong></td></tr>
<tr valign="top"><td>BioSample</td>
<td><a href="https://www.ncbi.nlm.nih.gov/biosample/SAMN29402605">SAMN29402605</a></td>
</tr>
<tr valign="top"><td>SRA</td>
<td><a href="https://www.ncbi.nlm.nih.gov/sra?term=SRX15929967">SRX15929967</a></td>
</tr>
</table>
...
<tr valign="top"><td bgcolor="#DEEBDC">GSM6278577_UPN4_PrePost_T_GEX.h5</td>
<td bgcolor="#DEEBDC" title="9866155">9.4 Mb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM6278nnn/GSM6278577/suppl/GSM6278577%5FUPN4%5FPrePost%5FT%5FGEX%2Eh5">(ftp)</a><a href="/geo/download/?acc=GSM6278577&amp;format=file&amp;file=GSM6278577%5FUPN4%5FPrePost%5FT%5FGEX%2Eh5">(http)</a></td>
<td bgcolor="#DEEBDC">H5</td>
</tr>
<tr><td><a href="/Traces/study/?acc=SRX15929967">SRA Run Selector</a><a href="javascript:RPopUpWindow_Set(geoaxema_srarun,260,120,'','','#E1EAE6','','#538AA9','MessageBox2');" onmouseout="RPopUpWindow_Stop()"><img alt="Help" height="11" src="/coreweb/images/long_help4.gif" style="border: none" width="19"></a></td></tr>
