...
<meta name="ncbi_phid" content="0C427AED9D0DBE910000000000000001">
<meta name="ncbi_sessionid" content="0C427AED9D0DBE91_0000SID">
...
<td align="right">Not logged in | <a href="/geo/submitter?ix=1ZyVSjNnTYCthyt27JZU6fAek8KFPVVr4K7C2Q6BkBB7sKZbeXSnPo4TNfJuKyA-tbepi2CF0JooWwsO5d6Ql6">Login</a><a href="javascript:RPopUpWindow_Set(geologinbar_login,260,200,'','','#E1EAE6','','#538AA9','MessageBox2');" onmouseout="RPopUpWindow_Stop()"><img alt="Help" height="11" src="/coreweb/images/long_help4.gif" style="border: none" width="19"></a></td>
</tr></table>
                    </td>
...
&nbsp;<label for="geo_acc">GEO accession: </label><input id="geo_acc" name="acc" onkeydown="ViewOptionsFormKeyDown(event)" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_acc)" style="font-size: 10px" type="text" value="GSM7974493">&nbsp;&nbsp;</td>
<td valign="middle"><img alt="Go" border="0" onclick="SubmitViewOptionsForm()" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_go)" src="/geo/img/buttons/go_button.gif"></td>
    ...
    <table><tr><td><table cellpadding="2" cellspacing="0" width="600"><tr bgcolor="#cccccc" valign="top"><td colspan="2"><table width="600"><tr><td><strong class="acc" id="GSM7974493"><a href="/geo/query/acc.cgi?acc=GSM7974493" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">Sample GSM7974493</a></strong></td>
<td></td>
<td align="right" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_gds)"><a href="/gds/?term=GSM7974493[Accession]">Query DataSets for GSM7974493</a></td>
</tr></table></td></tr>
<tr valign="top"><td>Status</td>
<td>Public on Jun 28, 2024</td>
</tr>
<tr valign="top"><td nowrap>Title</td>
<td style="text-align: justify">V4_C</td>
</tr>
...
<td style="text-align: justify">tissue: Kidney<br>condition: ANCA-GN<br></td>
</tr>
<tr valign="top"><td nowrap>Extracted molecule</td>
<td>total RNA</td>
</tr>
<tr valign="top"><td nowrap>Extraction protocol</td>
<td style="text-align: justify">Formalin-fixed paraffin-embedded (FFPE) kidney tissue sections from kidney were prepared as per recommendations from the 10x.<br>Spatial transcriptome sequencing libraries were prepared with 10xGenomics Visium Spatail Gene Expression Slides &amp; Reagent kit according to manufacturer's construction<br>Spatial Transcriptomics<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td style="text-align: justify">FFPE gene expression human transcriptome sequencing<br></td>
</tr>
<tr valign="top"><td nowrap>Data processing</td>
<td style="text-align: justify">Raw sequencing data were processed using the 10x Genomics Space Ranger pipeline (v2.0.1) to generate FASTQ files<br>Sequences were aligned to hg38 genome to gene expression count using Space Ranger's default settings<br>Gene expression level of genes in FFPE probe sets were quantified using Space Ranger's default settings<br>The h5ad files are AnnData objects that contain the final processed and analyzed 10x Visium data (from the samples that are already on GEO) using the Scanpy and anndata Python libraries.<br>Assembly: hg38<br>Supplementary files format and content: barcodes.tsv.gz:  list of spatial barcodes<br>Supplementary files format and content: features.tsv.gz:  list of gene IDs<br>Supplementary files format and content: matrix.mtx.gz:  gene expresion count data in Matrix Market Exchange Format<br>Supplementary files format and content: aligned_fiducials.jpg:  aligned fiducials of the tissue image<br>Supplementary files format and content: detected_tissue_image.jpg:  image of tissue and spots<br>Supplementary files format and content: scalefactors_json.json:  scalefactors in json format<br>Supplementary files format and content: tissue_hires_image.png:  hi-res image of tissue<br>Supplementary files format and content: tissue_lowres_image.png:  low-res image of tissue<br>Supplementary files format and content: tissue_positions.csv:  list of spatial barcodes and the coordinates specifying spots<br>Supplementary files format and content: .h5ad: final processed object<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td><a href="mailto:robin.khatri@zmnh.uni-hamburg.de">robin.khatri@zmnh.uni-hamburg.de</a><br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Organization name</td>
<td style="text-align: justify">University Medical Center Hamburg-Eppendorf<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Department</td>
<td style="text-align: justify">Institute of Medical Systems Biology<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Street address</td>
<td style="text-align: justify">Falkenried 94<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>City</td>
<td style="text-align: justify">Hamburg</td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>ZIP/Postal code</td>
<td style="text-align: justify">20251</td>
</tr>
...
<td><a href="/geo/query/acc.cgi?acc=GPL24676">GPL24676</a></td>
</tr>
<tr valign="top"><td>Series (1)</td>
<td onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)"><table cellpadding="3" style="position:relative;top:-5px;left:-5px"><tr><td valign="top"><a href="/geo/query/acc.cgi?acc=GSE250138" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">GSE250138</a></td>
<td valign="top">Immune profiling-based targeting of pathogenic T cells with ustekinumab in ANCA-associated glomerulonephritis</td>
</tr></table></td>
</tr>
<tr valign="top"><td colspan="2"><strong>Relations</strong></td></tr>
<tr valign="top"><td>BioSample</td>
<td><a href="https://www.ncbi.nlm.nih.gov/biosample/SAMN38814056">SAMN38814056</a></td>
</tr>
<tr valign="top"><td>SRA</td>
<td><a href="https://www.ncbi.nlm.nih.gov/sra?term=SRX22881379">SRX22881379</a></td>
</tr>
</table>
...
<tr valign="top"><td bgcolor="#DEEBDC">GSM7974493_V4_C_aligned_fiducials.jpg.gz</td>
<td bgcolor="#DEEBDC" title="1363803">1.3 Mb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Faligned%5Ffiducials%2Ejpg%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Faligned%5Ffiducials%2Ejpg%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">JPG</td>
</tr>
<tr valign="top"><td bgcolor="#EEEEEE">GSM7974493_V4_C_barcodes.tsv.gz</td>
<td bgcolor="#EEEEEE" title="4226">4.1 Kb</td>
<td bgcolor="#EEEEEE"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Fbarcodes%2Etsv%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Fbarcodes%2Etsv%2Egz">(http)</a></td>
<td bgcolor="#EEEEEE">TSV</td>
</tr>
<tr valign="top"><td bgcolor="#DEEBDC">GSM7974493_V4_C_detected_tissue_image.jpg.gz</td>
<td bgcolor="#DEEBDC" title="781683">763.4 Kb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Fdetected%5Ftissue%5Fimage%2Ejpg%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Fdetected%5Ftissue%5Fimage%2Ejpg%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">JPG</td>
</tr>
<tr valign="top"><td bgcolor="#EEEEEE">GSM7974493_V4_C_features.tsv.gz</td>
<td bgcolor="#EEEEEE" title="155265">151.6 Kb</td>
<td bgcolor="#EEEEEE"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Ffeatures%2Etsv%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Ffeatures%2Etsv%2Egz">(http)</a></td>
<td bgcolor="#EEEEEE">TSV</td>
</tr>
<tr valign="top"><td bgcolor="#DEEBDC">GSM7974493_V4_C_matrix.mtx.gz</td>
<td bgcolor="#DEEBDC" title="8891712">8.5 Mb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Fmatrix%2Emtx%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Fmatrix%2Emtx%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">MTX</td>
</tr>
<tr valign="top"><td bgcolor="#EEEEEE">GSM7974493_V4_C_scalefactors_json.json.gz</td>
<td bgcolor="#EEEEEE" title="169">169 b</td>
<td bgcolor="#EEEEEE"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Fscalefactors%5Fjson%2Ejson%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Fscalefactors%5Fjson%2Ejson%2Egz">(http)</a></td>
<td bgcolor="#EEEEEE">JSON</td>
</tr>
<tr valign="top"><td bgcolor="#DEEBDC">GSM7974493_V4_C_tissue_hires_image.png.gz</td>
<td bgcolor="#DEEBDC" title="5590701">5.3 Mb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Ftissue%5Fhires%5Fimage%2Epng%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Ftissue%5Fhires%5Fimage%2Epng%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">PNG</td>
</tr>
<tr valign="top"><td bgcolor="#EEEEEE">GSM7974493_V4_C_tissue_lowres_image.png.gz</td>
<td bgcolor="#EEEEEE" title="658625">643.2 Kb</td>
<td bgcolor="#EEEEEE"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Ftissue%5Flowres%5Fimage%2Epng%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Ftissue%5Flowres%5Fimage%2Epng%2Egz">(http)</a></td>
<td bgcolor="#EEEEEE">PNG</td>
</tr>
<tr valign="top"><td bgcolor="#DEEBDC">GSM7974493_V4_C_tissue_positions.csv.gz</td>
<td bgcolor="#DEEBDC" title="55332">54.0 Kb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM7974nnn/GSM7974493/suppl/GSM7974493%5FV4%5FC%5Ftissue%5Fpositions%2Ecsv%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM7974493&amp;format=file&amp;file=GSM7974493%5FV4%5FC%5Ftissue%5Fpositions%2Ecsv%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">CSV</td>
</tr>
<tr><td><a href="/Traces/study/?acc=SRX22881379">SRA Run Selector</a><a href="javascript:RPopUpWindow_Set(geoaxema_srarun,260,120,'','','#E1EAE6','','#538AA9','MessageBox2');" onmouseout="RPopUpWindow_Stop()"><img alt="Help" height="11" src="/coreweb/images/long_help4.gif" style="border: none" width="19"></a></td></tr>
