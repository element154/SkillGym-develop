...
<meta name="ncbi_phid" content="075138C69D0DBEF10000000000000001">
<meta name="ncbi_sessionid" content="075138C69D0DBEF1_0000SID">
...
&nbsp;<label for="geo_acc">GEO accession: </label><input id="geo_acc" name="acc" onkeydown="ViewOptionsFormKeyDown(event)" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_acc)" style="font-size: 10px" type="text" value="GSM5224029">&nbsp;&nbsp;</td>
<td valign="middle"><img alt="Go" border="0" onclick="SubmitViewOptionsForm()" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_go)" src="/geo/img/buttons/go_button.gif"></td>
    ...
    <table><tr><td><table cellpadding="2" cellspacing="0" width="600"><tr bgcolor="#cccccc" valign="top"><td colspan="2"><table width="600"><tr><td><strong class="acc" id="GSM5224029"><a href="/geo/query/acc.cgi?acc=GSM5224029" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">Sample GSM5224029</a></strong></td>
<td></td>
<td align="right" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_gds)"><a href="/gds/?term=GSM5224029[Accession]">Query DataSets for GSM5224029</a></td>
</tr></table></td></tr>
<tr valign="top"><td>Status</td>
<td>Public on Jun 04, 2021</td>
</tr>
<tr valign="top"><td nowrap>Title</td>
<td style="text-align: justify">MIBC_B72</td>
</tr>
...
<td style="text-align: justify">MIBC<br></td>
</tr>
...
<td style="text-align: justify">tissue: muscle-invasive bladder cancer (MIBC)<br></td>
</tr>
<tr valign="top"><td nowrap>Extracted molecule</td>
<td>polyA RNA</td>
</tr>
<tr valign="top"><td nowrap>Extraction protocol</td>
<td style="text-align: justify">Tissue optimization was performed on one representative MIBC sample from the cohort used in this study, and the optimal permeabilization time was determined to be 24 minutes. Then 4 samples were cryosectioned at 10mm and processed according to the 10x Visium protocol.<br>Libraries were constructed according to the 10x Visium library construction protocol and sequenced by Illumina to a sequencing saturation of approximately 90%.<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td style="text-align: justify">Visium spatial transcriptomics of MIBC tissue<br></td>
</tr>
<tr valign="top"><td nowrap>Data processing</td>
<td style="text-align: justify">Samples were processed with SpaceRanger (10X genomics, v1.1.0) using the same pre-mrna reference as for the snSeq data analysis to improve consistency between the two datasets.<br>Genome_build: GRCh38<br>Supplementary_files_format_and_content: combined_visium.h5ad contains processed data for all spots passing QC filtering. These files contain raw counts for every gene in every spot as well as metadata such as sample identity. A1,B1,C1, and D1.jpg are the associated H&amp;E images for each sample.<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td>Kenneth Howard Gouin III</td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>E-mail(s)</td>
<td><a href="mailto:Kgouiniii@gmail.com">Kgouiniii@gmail.com</a><br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Organization name</td>
<td style="text-align: justify">Cedars-Sinai Medical Center<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Street address</td>
<td style="text-align: justify">8700 Beverly Blvd<br></td>
</tr>
...
<td style="text-align: justify">90048</td>
</tr>
...
<td onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)"><table cellpadding="3" style="position:relative;top:-5px;left:-5px"><tr><td valign="top"><a href="/geo/query/acc.cgi?acc=GSE171351" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">GSE171351</a></td>
<td valign="top">A new epithelial cell subpopulation predicts response to surgery, chemotherapy, and immunotherapy in bladder cancer</td>
</tr></table></td>
</tr>
<tr valign="top"><td colspan="2"><strong>Relations</strong></td></tr>
<tr valign="top"><td>BioSample</td>
<td><a href="https://www.ncbi.nlm.nih.gov/biosample/SAMN18590401">SAMN18590401</a></td>
</tr>
<tr valign="top"><td>SRA</td>
<td><a href="https://www.ncbi.nlm.nih.gov/sra?term=SRX10501906">SRX10501906</a></td>
</tr>
</table>
...
<tr valign="top"><td bgcolor="#DEEBDC">GSM5224029_C1.jpg.gz</td>
<td bgcolor="#DEEBDC" title="21137453">20.2 Mb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM5224nnn/GSM5224029/suppl/GSM5224029%5FC1%2Ejpg%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM5224029&amp;format=file&amp;file=GSM5224029%5FC1%2Ejpg%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">JPG</td>
</tr>
<tr><td><a href="/Traces/study/?acc=SRX10501906">SRA Run Selector</a><a href="javascript:RPopUpWindow_Set(geoaxema_srarun,260,120,'','','#E1EAE6','','#538AA9','MessageBox2');" onmouseout="RPopUpWindow_Stop()"><img alt="Help" height="11" src="/coreweb/images/long_help4.gif" style="border: none" width="19"></a></td></tr>
