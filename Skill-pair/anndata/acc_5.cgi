...
<meta name="ncbi_phid" content="075107269D0DBC610000000000000001">
<meta name="ncbi_sessionid" content="075107269D0DBC61_0000SID">
...
&nbsp;<label for="geo_acc">GEO accession: </label><input id="geo_acc" name="acc" onkeydown="ViewOptionsFormKeyDown(event)" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_acc)" style="font-size: 10px" type="text" value="GSM5026378">&nbsp;&nbsp;</td>
<td valign="middle"><img alt="Go" border="0" onclick="SubmitViewOptionsForm()" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_go)" src="/geo/img/buttons/go_button.gif"></td>
    ...
    <table><tr><td><table cellpadding="2" cellspacing="0" width="600"><tr bgcolor="#cccccc" valign="top"><td colspan="2"><table width="600"><tr><td><strong class="acc" id="GSM5026378"><a href="/geo/query/acc.cgi?acc=GSM5026378" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">Sample GSM5026378</a></strong></td>
<td></td>
<td align="right" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_gds)"><a href="/gds/?term=GSM5026378[Accession]">Query DataSets for GSM5026378</a></td>
</tr></table></td></tr>
<tr valign="top"><td>Status</td>
<td>Public on Sep 22, 2021</td>
</tr>
<tr valign="top"><td nowrap>Title</td>
<td style="text-align: justify">E13_MGE_multi_atac</td>
</tr>
...
<td style="text-align: justify">medial ganglionic eminence<br></td>
</tr>
...
<td style="text-align: justify">ATAC from the same barcoded cells as Gene expression (RNA) sample<br></td>
</tr>
<tr valign="top"><td nowrap>Data processing</td>
<td style="text-align: justify">Raw multiomic data was processed using the Cell Ranger ARC v1.0.0 pipeline (10x Genomics). Reads were aligned to the GRCm38 (mm10) mus musculus genome.<br>Read filtering, alignment, and barcode counting were performed using cellranger-arc count.<br>Genome_build: mm10<br>Supplementary_files_format_and_content: barcodes.tsv file containing cell barcodes  present in the corresponding expression matrix.<br>Supplementary_files_format_and_content: features.tsv file containing gene IDs and names present in the corresponding expression matrix.<br>Supplementary_files_format_and_content: matrix.mtx file is sparse matrix containing feature-barcode matrices.<br>Supplementary_files_format_and_content: The fragments.tsv.gz file is  a tabular file where each line represents a unique ATAC-seq fragment. Duplicate reads are collapsed into a single fragment record.<br>Supplementary_files_format_and_content: The per_barcode_metrics.csv file contains QC information associated with each barcode for cell-calling.<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td>Kathryn Allaway</td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Organization name</td>
<td style="text-align: justify">Broad Institute<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Department</td>
<td style="text-align: justify">Stanley Center for Psychiatric Disease<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Lab</td>
<td style="text-align: justify">Fishell Lab<br></td>
</tr>
...
<td onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)"><table cellpadding="3" style="position:relative;top:-5px;left:-5px"><tr><td valign="top"><a href="/geo/query/acc.cgi?acc=GSE165114" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">GSE165114</a></td>
<td valign="top">Multiomic sequencing of the MGE</td>
</tr>
<tr><td valign="top"><a href="/geo/query/acc.cgi?acc=GSE165233" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">GSE165233</a></td>
<td valign="top">Genetic and epigenetic coordination of cortical interneuron development</td>
</tr>
</table></td>
</tr>
<tr valign="top"><td colspan="2"><strong>Relations</strong></td></tr>
<tr valign="top"><td>BioSample</td>
<td><a href="https://www.ncbi.nlm.nih.gov/biosample/SAMN17383959">SAMN17383959</a></td>
</tr>
<tr valign="top"><td>SRA</td>
<td><a href="https://www.ncbi.nlm.nih.gov/sra?term=SRX9897323">SRX9897323</a></td>
</tr>
</table>
...
<tr valign="top"><td bgcolor="#DEEBDC">GSM5026378_E13_MGE_multi_atac_fragments.tsv.gz</td>
<td bgcolor="#DEEBDC" title="1888322124">1.8 Gb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM5026nnn/GSM5026378/suppl/GSM5026378%5FE13%5FMGE%5Fmulti%5Fatac%5Ffragments%2Etsv%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM5026378&amp;format=file&amp;file=GSM5026378%5FE13%5FMGE%5Fmulti%5Fatac%5Ffragments%2Etsv%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">TSV</td>
</tr>
<tr valign="top"><td bgcolor="#EEEEEE">GSM5026378_E13_MGE_multi_per_barcode_metrics.csv.gz</td>
<td bgcolor="#EEEEEE" title="22985933">21.9 Mb</td>
<td bgcolor="#EEEEEE"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM5026nnn/GSM5026378/suppl/GSM5026378%5FE13%5FMGE%5Fmulti%5Fper%5Fbarcode%5Fmetrics%2Ecsv%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM5026378&amp;format=file&amp;file=GSM5026378%5FE13%5FMGE%5Fmulti%5Fper%5Fbarcode%5Fmetrics%2Ecsv%2Egz">(http)</a></td>
<td bgcolor="#EEEEEE">CSV</td>
</tr>
<tr><td><a href="/Traces/study/?acc=SRX9897323">SRA Run Selector</a><a href="javascript:RPopUpWindow_Set(geoaxema_srarun,260,120,'','','#E1EAE6','','#538AA9','MessageBox2');" onmouseout="RPopUpWindow_Stop()"><img alt="Help" height="11" src="/coreweb/images/long_help4.gif" style="border: none" width="19"></a></td></tr>
