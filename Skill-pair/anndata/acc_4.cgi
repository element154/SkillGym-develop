...
<meta name="ncbi_phid" content="0C423B549D0DBC010000000000000001">
<meta name="ncbi_sessionid" content="0C423B549D0DBC01_0000SID">
...
<td align="right">Not logged in | <a href="/geo/submitter?ix=16w9r2BiKNWCF1Pe8Y8DJVIraHKRtbBGZz2JtMBNy0GVC1xkawhgrPZ9e5jxT9cXAIni0S8AKGRD01YTRxNMcd">Login</a><a href="javascript:RPopUpWindow_Set(geologinbar_login,260,200,'','','#E1EAE6','','#538AA9','MessageBox2');" onmouseout="RPopUpWindow_Stop()"><img alt="Help" height="11" src="/coreweb/images/long_help4.gif" style="border: none" width="19"></a></td>
</tr></table>
                    </td>
...
&nbsp;<label for="geo_acc">GEO accession: </label><input id="geo_acc" name="acc" onkeydown="ViewOptionsFormKeyDown(event)" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_acc)" style="font-size: 10px" type="text" value="GSM4909253">&nbsp;&nbsp;</td>
<td valign="middle"><img alt="Go" border="0" onclick="SubmitViewOptionsForm()" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_go)" src="/geo/img/buttons/go_button.gif"></td>
    ...
    <table><tr><td><table cellpadding="2" cellspacing="0" width="600"><tr bgcolor="#cccccc" valign="top"><td colspan="2"><table width="600"><tr><td><strong class="acc" id="GSM4909253"><a href="/geo/query/acc.cgi?acc=GSM4909253" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">Sample GSM4909253</a></strong></td>
<td></td>
<td align="right" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_gds)"><a href="/gds/?term=GSM4909253[Accession]">Query DataSets for GSM4909253</a></td>
</tr></table></td></tr>
<tr valign="top"><td>Status</td>
<td>Public on Mar 19, 2021</td>
</tr>
<tr valign="top"><td nowrap>Title</td>
<td style="text-align: justify">Normal Total cells from Patient 0092</td>
</tr>
...
<td style="text-align: justify">Mammary gland<br></td>
</tr>
...
<td style="text-align: justify">patient: 0092<br>gender: Female<br>menopause: Pre<br>parity: Nulliparous<br>cancer type: Normal<br>cell population: Total<br>number of cells: 4966<br></td>
</tr>
...
<td style="text-align: justify">Read alignment and count summarization were performed using CellRanger v3.0.2 using the Illumina BCL files as input.<br>Genome_build: GRCh38<br>Supplementary_files_format_and_content: matrix.mtx files contain genewise read counts for all cells in the space-efficient matrix market format. The supplementary file features.tsv.gz contains the corresponding Ensembl IDs and gene symbols as tab-delimited text. The barcode.tsv files contain the 10X barcodes used to identify cells. Each matrix market file can be read into R, together with features.tsv.gz, using the read10X function of the edgeR software package.<br></td>
</tr>
<tr valign="top"><td nowrap>&nbsp;</td>
<td></td>
</tr>
...
<td>Gordon K Smyth</td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>E-mail(s)</td>
<td><a href="mailto:smyth@wehi.edu.au">smyth@wehi.edu.au</a><br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Phone</td>
<td style="text-align: justify"> (+61 3) 9345 2326<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Fax</td>
<td style="text-align: justify"> (+61 3) 9347 0852<br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>URL</td>
<td><a href="http://www.wehi.edu.au">http://www.wehi.edu.au</a><br></td>
</tr>
<tr bgcolor="#eeeeee" valign="top"><td nowrap>Organization name</td>
<td style="text-align: justify">Walter and Eliza Hall Institute of Medical Research<br></td>
</tr>
...
<td onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)"><table cellpadding="3" style="position:relative;top:-5px;left:-5px"><tr><td valign="top"><a href="/geo/query/acc.cgi?acc=GSE161529" onmouseout="onLinkOut('HelpMessage' , geo_empty_help)" onmouseover="onLinkOver('HelpMessage' , geoaxema_recenter)">GSE161529</a></td>
<td valign="top">scRNA-seq profiling of breast cancer tumors, BRCA1 mutant pre-neoplastic mammary gland cells and normal mammary gland cells</td>
</tr></table></td>
</tr>
<tr valign="top"><td colspan="2"><strong>Relations</strong></td></tr>
<tr valign="top"><td>Reanalyzed by</td>
<td><a href="/geo/query/acc.cgi?acc=GSE276609">GSE276609</a></td>
</tr>
<tr valign="top"><td>BioSample</td>
<td><a href="https://www.ncbi.nlm.nih.gov/biosample/SAMN16809172">SAMN16809172</a></td>
</tr>
</table>
...
<tr valign="top"><td bgcolor="#DEEBDC">GSM4909253_N-PM0092-Total-barcodes.tsv.gz</td>
<td bgcolor="#DEEBDC" title="25449">24.9 Kb</td>
<td bgcolor="#DEEBDC"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM4909nnn/GSM4909253/suppl/GSM4909253%5FN%2DPM0092%2DTotal%2Dbarcodes%2Etsv%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM4909253&amp;format=file&amp;file=GSM4909253%5FN%2DPM0092%2DTotal%2Dbarcodes%2Etsv%2Egz">(http)</a></td>
<td bgcolor="#DEEBDC">TSV</td>
</tr>
<tr valign="top"><td bgcolor="#EEEEEE">GSM4909253_N-PM0092-Total-matrix.mtx.gz</td>
<td bgcolor="#EEEEEE" title="34879337">33.3 Mb</td>
<td bgcolor="#EEEEEE"><a href="ftp://ftp.ncbi.nlm.nih.gov/geo/samples/GSM4909nnn/GSM4909253/suppl/GSM4909253%5FN%2DPM0092%2DTotal%2Dmatrix%2Emtx%2Egz">(ftp)</a><a href="/geo/download/?acc=GSM4909253&amp;format=file&amp;file=GSM4909253%5FN%2DPM0092%2DTotal%2Dmatrix%2Emtx%2Egz">(http)</a></td>
<td bgcolor="#EEEEEE">MTX</td>
</tr>
